...
import {FaCode, FaEnvelope, FaHome, FaProjectDiagram, FaUser} from 'react-icons/fa'
import {motion} from 'framer-motion'
import {Moon, Sun} from "lucide-react";

// @ts-ignore TODO: remove this after enforcing the types
const NavBar = ({darkMode, toggleDarkMode}) => {
    //HOOKS
    const[activeTab, setActiveTab] = useState('Home')

    //Navigation Bar Items
    //TODO: Update 'EXPERIENCE' icon with a proper one from react-icons/fa
    const navItems = [
    ...
    return (
        <div className='fixed z-50 bottom-0 left-0 right-0 flex justify-center'>
            ...
            >
                ...
                <div className='relative bg-linear-to-r from-red-600 to-red-800 backdrop-blur-xl rounded-2xl shadow-2xl
